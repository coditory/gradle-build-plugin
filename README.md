...
[![Gradle Plugin Portal](https://img.shields.io/badge/Plugin_Portal-v0.1.8-green.svg)](https://plugins.gradle.org/plugin/com.coditory.build)
...
```gradle
plugins {
  id 'com.coditory.build' version '0.1.8'
}
```
